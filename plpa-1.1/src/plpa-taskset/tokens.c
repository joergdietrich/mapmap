  ...
  switch (yyn)
    {
        case 2:
#line 83 "tokens.y"
    { set_copy(return_value, &(yyvsp[(1) - (1)].cpu_set)); }
    break;
...
#line 85 "tokens.y"
  ...
  case 4:
#line 88 "tokens.y"
    { set_copy(&(yyval.cpu_set), &(yyvsp[(1) - (1)].cpu_set)); }
    break;
...
#line 90 "tokens.y"
  ...
  case 6:
#line 93 "tokens.y"
    { cpu_set(&(yyval.cpu_set), (yyvsp[(1) - (1)].number)); }
    break;

  case 7:
#line 95 "tokens.y"
    { cpu_set_range(&(yyval.cpu_set), (yyvsp[(1) - (3)].number), (yyvsp[(3) - (3)].number)); }
    break;

  case 8:
#line 97 "tokens.y"
    { PLPA_NAME(cpu_set_t) temp; cpu_set(&temp, (yyvsp[(3) - (3)].number)); set_union(&(yyval.cpu_set), &(yyvsp[(1) - (3)].cpu_set), &temp); }
    break;

  case 9:
#line 99 "tokens.y"
    { PLPA_NAME(cpu_set_t) temp; cpu_set_range(&temp, (yyvsp[(3) - (5)].number), (yyvsp[(5) - (5)].number)); set_union(&(yyval.cpu_set), &(yyvsp[(1) - (5)].cpu_set), &temp); }
    break;
...
#line 109 "tokens.y"
  ...
  case 14:
#line 111 "tokens.y"
    { set_union(&(yyval.cpu_set), &(yyvsp[(1) - (3)].cpu_set), &(yyvsp[(3) - (3)].cpu_set)); }
    break;

  case 15:
#line 114 "tokens.y"
    { sc_merge(&(yyval.cpu_set), &(yyvsp[(1) - (3)].cpu_set), 1, &(yyvsp[(3) - (3)].cpu_set), 1); }
    break;

  case 16:
#line 116 "tokens.y"
    { sc_merge(&(yyval.cpu_set), &(yyvsp[(1) - (3)].cpu_set), 1, &(yyvsp[(3) - (3)].cpu_set), 0); }
    break;

  case 17:
#line 118 "tokens.y"
    { sc_merge(&(yyval.cpu_set), &(yyvsp[(1) - (3)].cpu_set), 0, &(yyvsp[(3) - (3)].cpu_set), 1); }
    break;

  case 18:
#line 120 "tokens.y"
    { sc_merge(&(yyval.cpu_set), &(yyvsp[(1) - (3)].cpu_set), 0, &(yyvsp[(3) - (3)].cpu_set), 0); }
    break;
...
#line 123 "tokens.y"
  ...
  case 20:
#line 125 "tokens.y"
    { PLPA_NAME(cpu_set_t) temp; cpu_set(&temp, (yyvsp[(2) - (2)].number)); cpu_compliment(&(yyval.cpu_set), &temp); }
    break;

  case 21:
#line 127 "tokens.y"
    { cpu_compliment(&(yyval.cpu_set), &(yyvsp[(3) - (4)].cpu_set)); }
    break;

  case 22:
#line 129 "tokens.y"
    { set_copy(&(yyval.cpu_set), &(yyvsp[(2) - (3)].cpu_set)); }
    break;
